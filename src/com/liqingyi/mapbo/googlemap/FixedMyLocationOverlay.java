...
/**
 * Fixes bug with some phone's location overlay class (ie Droid X). Essentially,
 * it attempts to use the default MyLocationOverlay class, but if it fails, we
 * override the drawMyLocation method to provide an icon and accuracy circle to
 * mimic showing user's location. Right now the icon is a static image. If you
 * want to have it animate, modify the drawMyLocation method.
 */
